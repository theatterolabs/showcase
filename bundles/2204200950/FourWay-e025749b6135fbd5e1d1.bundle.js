...
var _styles = __webpack_require__(3621);

var _styles2 = _interopRequireDefault(_styles);

var _styles3 = __webpack_require__(3622);
...
var _fourwayexport = __webpack_require__(3623);

var _fourwayexport2 = _interopRequireDefault(_fourwayexport);
...
function FourWay(props) {
  ...
  var _useState3 = (0, _react.useState)([]),
      _useState4 = (0, _slicedToArray3.default)(_useState3, 2),
      blobs = _useState4[0],
      setBlobs = _useState4[1];

  var _useState5 = (0, _react.useState)(false),
      _useState6 = (0, _slicedToArray3.default)(_useState5, 2),
      shareMenuOpened = _useState6[0],
      setShareMenuOpened = _useState6[1];

  var _useState7 = (0, _react.useState)(false),
      _useState8 = (0, _slicedToArray3.default)(_useState7, 2),
      emailSharingModalOpened = _useState8[0],
      setEmailSharingModalOpened = _useState8[1];

  var canvasRef = (0, _react.useRef)(null);
  var imageSize = (0, _react.useRef)({ width: 0, height: 0 });
  var watermark = settings.getModuleSetting() && (0, _get3.default)(settings.getModuleSetting().getGeneral(), 'configs.watermark');

  var _useState9 = (0, _react.useState)(false),
      _useState10 = (0, _slicedToArray3.default)(_useState9, 2),
      snapshotting = _useState10[0],
      setSnapshotting = _useState10[1];

  var _useShare = (0, _useShare3.default)({ emitter: emitter, settings: settings }),
      uploading = _useShare.uploading,
      uploadBase64 = _useShare.uploadBase64,
      submitShare = _useShare.submitShare;

  var onFourWayOffClick = function onFourWayOffClick() {
  ...
  var getDefaultText = function getDefaultText() {
    return _react2.default.createElement(
      'div',
      {
        id: 'fourway-default-text',
        style: (0, _extends3.default)({}, styles.defaultText, {
          width: settings.displayWidth / 2 + 'px'
        })
      },
      settings.isBeardDyeOnly() ? settings.i18n.getMessage('4way.try.other.beard') : settings.i18n.getMessage('4way.try.other.color')
    );
  };

  var addImage = function addImage(image) {
    setBlocks(function (prev) {
      var temp = [].concat((0, _toConsumableArray3.default)(prev));
      temp.unshift(image);
      temp.splice(4);
      return temp;
    });
  ...
  var setImageResolution = function setImageResolution(blob, callback) {
    return _ymkWebSdkCore.fileUtils.toBase64(blob, function (base64) {
      var image = new Image();
      image.onload = function () {
        imageSize.current = { height: image.height, width: image.width };
        callback && callback();
      };
      image.src = base64;
    });
  ...
  var createImage = function createImage(blob, callback) {
    var h2 = settings.displayHeight / 2;
    var w2 = settings.displayWidth / 2;
    var w = imageSize.current.width / imageSize.current.height * h2;
    var marginLeft = (w2 - w) / 2;
    _ymkWebSdkCore.fileUtils.toBase64(blob, function (base64) {
      return callback(_react2.default.createElement('img', { crossOrigin: 'anonymous', src: base64, style: { marginLeft: marginLeft + 'px', height: h2 + 'px' } }));
    });
  };
  ...
  var onEmailSharingSubmit = function onEmailSharingSubmit(displayName, email) {
    snapshot(function (blobOrBase64) {
      _ymkWebSdkCore.fileUtils.toBase64(blobOrBase64, function (base64) {
        submitShare(_useShare2.shareTargets.email, { displayName: displayName, email: email, src: base64 });
  ...
  var onSaveClick = function onSaveClick() {
    return snapshot(function (blobOrBase64) {
      _ymkWebSdkCore.fileUtils.savePhotoByBlob(blobOrBase64, settings.getModuleSetting().getDownloadFileName());
      closeShareMenu();
    });
  };

  var snapshot = function snapshot(callback) {
    return canvasRef.current && (0, _html2canvas2.default)(canvasRef.current, {
      scale: 2,
      logging: false
    }).then(function (canvas) {
      if (canvas.msToBlob) {
        callback && callback(canvas.msToBlob());
      } else {
  ...
  var snapshotThenUpload = function snapshotThenUpload() {
    if (uploading || snapshotting) {
      return;
    }
  ...
  var handleSplitFourWayChanged = function handleSplitFourWayChanged(blobs) {
    setBlobs(blobs);
    if (!imageSize.current.width) {
      setImageResolution(blobs[0], function () {
        return createImage(blobs[0], addImage);
      });
    } else {
      createImage(blobs[0], addImage);
    }
  };

  (0, _react.useEffect)(function () {
    setBlocks([getDefaultText(), getDefaultText(), getDefaultText(), getDefaultText()]);
    emitter.on(_ymkWebSdkCore.events.splitFourWayChanged, handleSplitFourWayChanged);
    emitter.trigger(_ymkWebSdkCore.events.splitFourWay);
    emitter.trigger(_ymkWebSdkCore.events.a11yMessage, [settings.i18n.getMessage('a11y.label.4way.started')]);

    return function () {
      emitter.off(_ymkWebSdkCore.events.splitFourWayChanged, handleSplitFourWayChanged);
      emitter.trigger(_ymkWebSdkCore.events.splitFourWayOff);
      emitter.trigger(_ymkWebSdkCore.events.a11yMessage, [settings.i18n.getMessage('a11y.label.4way.ended')]);
    };
  }, []);

  var w2 = settings.displayWidth / 2 + 'px';
  var h2 = settings.displayHeight / 2 + 'px';
  return _react2.default.createElement(
    'div',
    { style: (0, _extends3.default)({}, styles.container, { height: settings.displayHeight + 'px', width: settings.displayWidth + 'px' }) },
    _react2.default.createElement(
      'div',
      { style: styles.rightButtons },
      _react2.default.createElement(_ActionButtonPanel2.default, { emitter: emitter, settings: settings, canFourWay: true, fourWayComparing: true, onFourWayOffClick: onFourWayOffClick }),
    ...
    _react2.default.createElement(
      ...
      [0, 1, 2, 3].map(function (index) {
        return _react2.default.createElement(
          'div',
          { key: 'way4_' + index, style: (0, _extends3.default)({}, styles.block, styles['block' + index], { height: h2, width: w2 }) },
          blocks[index]
        );
      })
    ),
    _react2.default.createElement(
      'div',
      { ref: canvasRef, style: { zIndex: 4, height: 'auto', width: 'auto', position: 'absolute' } },
      _react2.default.createElement(_fourwayexport2.default, { imageWidth: imageSize.current.width, imageHeight: imageSize.current.height, settings: settings, blobs: [].concat((0, _toConsumableArray3.default)(blobs)), blocks: blocks, watermark: watermark })
    ),
...
exports.default = {
  ...
  block0: {
    borderBottom: '0.035em solid #cbcbcb',
    borderRight: '0.035em solid #cbcbcb'
  },
  block1: {
    borderLeft: '0.035em solid #cbcbcb',
    borderBottom: '0.035em solid #cbcbcb'
  },
  block2: {
    borderRight: '0.035em solid #cbcbcb',
    borderTop: '0.035em solid #cbcbcb'
  },
  block3: {
    borderTop: '0.035em solid #cbcbcb',
    borderLeft: '0.035em solid #cbcbcb'
...
exports.default = FourWayExport;

var _react = __webpack_require__(459);

var _react2 = _interopRequireDefault(_react);

var _styles = __webpack_require__(3624);
...
function FourWayExport(props) {
  var settings = props.settings,
      blobs = props.blobs,
      imageWidth = props.imageWidth,
      imageHeight = props.imageHeight;

  var getOutputBlock1 = function getOutputBlock1() {
    var w = imageWidth / imageHeight * settings.displayHeight;
    var marginLeft = (settings.displayWidth - w) / 2;
    return _react2.default.createElement(
      'div',
      {
        style: {
      ...
      _react2.default.createElement('img', { alt: 'block 1', crossOrigin: 'anonymous', src: blobs[0], style: { height: settings.displayHeight + 'px', marginLeft: marginLeft + 'px' } }),
      getPowered()
    );
  };

  var getOutputBlock234 = function getOutputBlock234() {
    var h2 = settings.displayHeight / 2;
    var w2 = settings.displayWidth / 2;
    var w = imageWidth / imageHeight * h2;
    var marginLeft = (w2 - w) / 2;
    return _react2.default.createElement(
      'div',
      {
      ...
      blobs.map(function (b, i) {
        return _react2.default.createElement(
          'div',
          { key: 'way4_' + i, style: (0, _extends3.default)({}, _styles2.default.block, _styles2.default['block' + blobs.length + i], { height: h2, width: w2 }) },
          _react2.default.createElement('img', { alt: 'way4_' + i, crossOrigin: 'anonymous', src: b, style: { height: settings.displayHeight / 2 + 'px', marginLeft: marginLeft + 'px' } })
        );
      }),
      getPowered()
    );
  ...
  var getPowered = function getPowered() {
    return _react2.default.createElement(
      'div',
      {
        style: (0, _extends3.default)({}, _styles2.default.powered, {
          width: settings.displayWidth + 'px',
          fontFamily: _ymkWebSdkCore.browserUtils.isFirefox() ? 'times new roman' : 'inherit'
        })
      },
      'Powered by YouCam Makeup'
    );
  };

  var getOutputBlocks = function getOutputBlocks() {
    switch (blobs.length) {
      case 1:
        return getOutputBlock1();
      default:
        return getOutputBlock234();
    }
  };

  return getOutputBlocks();
}
module.exports = exports['default'];
...
exports.default = {
  ...
  block31: {
    borderLeft: '0.035em solid #cbcbcb',
    borderBottom: '0.07em solid #cbcbcb'
  },
  block32: {
    borderRight: '0.07em solid #cbcbcb',
    borderTop: '0.035em solid #cbcbcb'
  },
  block33: {
    borderLeft: '0.035em solid #cbcbcb',
