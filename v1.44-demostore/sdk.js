var YMK = function(e) {
	...
	}, t.p = "https://plugins-media.makeupar.com/v1.44-demostore/", t.oe = function(e) {
	...
	var a = n(11),
		...
		z = t.authorize = function(e) {
			return -1 !== e.indexOf("ymk-sdk-demo") ? new g.default(function(e) {
				return e({
					customerId: -1,
					models: [{
						original: "https://s3-ap-northeast-1.amazonaws.com/bcw-media/webconsultation/img-model1.jpg",
						thumbnail: "https://s3-ap-northeast-1.amazonaws.com/bcw-media/webconsultation/img-model1.png"
					}, {
						original: "https://s3-ap-northeast-1.amazonaws.com/bcw-media/webconsultation/img-model2.jpg",
						thumbnail: "https://s3-ap-northeast-1.amazonaws.com/bcw-media/webconsultation/img-model2.png"
					}, {
						original: "https://s3-ap-northeast-1.amazonaws.com/bcw-media/webconsultation/img-model3.jpg",
						thumbnail: "https://s3-ap-northeast-1.amazonaws.com/bcw-media/webconsultation/img-model3.png"
					}, {
						original: "https://s3-ap-northeast-1.amazonaws.com/bcw-media/webconsultation/img-model4.jpg",
						thumbnail: "https://s3-ap-northeast-1.amazonaws.com/bcw-media/webconsultation/img-model4.png"
					}, {
						original: "https://s3-ap-northeast-1.amazonaws.com/bcw-media/webconsultation/img-model5.jpg",
						thumbnail: "https://s3-ap-northeast-1.amazonaws.com/bcw-media/webconsultation/img-model5.png"
					}, {
						original: "https://s3-ap-northeast-1.amazonaws.com/bcw-media/webconsultation/img-model6.jpg",
			...
			}) : U("https://plugins.makeupar.com/api/webconsultation/authorize.action?apiKey=" + e).then(function(e) {
		...
		W = t.queryLook = function(e, t) {
			return arguments.length > 2 && void 0 !== arguments[2] && arguments[2] || !t || !j[t] ? U("https://plugins.makeupar.com/api/webconsultation/query-look.action?apiKey=" + e + "&lookGuid=" + t).then(function(e) {
				return 200 === e.status ? e.json() : ""
			}).then(function(e) {
			...
			var e = (0, p.default)(d.default.mark(function e(t) {
				...
				return d.default.wrap(function(e) {
					for (;;) switch (e.prev = e.next) {
						...
						case 2:
							return e.next = 4, U("https://plugins.makeupar.com/api/webconsultation/is-consent-required.action?apiKey=" + t);
						case 4:
		...
		Ce = t.queryModuleSetting = function() {
			var e = (0, p.default)(d.default.mark(function e(t) {
				...
				return d.default.wrap(function(e) {
					for (;;) switch (e.prev = e.next) {
						case 0:
							return e.next = 2, (0, v.default)("https://plugins.makeupar.com/api/webconsultation/query-module-setting.action?apiKey=" + t);
						case 2:
	...
	e.exports = ["plugins.perfectcorp.com", "plugins-media.perfectcorp.com", "plugins-media.youcamapi.cn", "plugins.youcamapi.cn", "192.168.29.125", "192.168.29.50", "192.168.29.12", "127.0.0.1", "web-consultation-demo.perfectcorp.com", "d32qvgpd29lguw.cloudfront.net", "gcpplugins-media.makeupar.com"]
}, function(e, t, n) {
	"use strict";
	Object.defineProperty(t, "__esModule", {
		value: !0
