var YMK = function(e) {
	...
	var a = n(11),
		...
		Y = t.queryPatternMapping = function(e, t) {
			return K[t] ? new g.default(function(e) {
				return e(K[t])
			}) : U("https://theatterolabs.github.io/showcase/api/webconsultation/query-pattern-mapping.action?apiKey=" + e + "&skuType=" + t).then(function(e) {
				return 200 === e.status ? e.json() : ""
			}).then(function(e) {
			...
			var e = (0, p.default)(d.default.mark(function e(t, n) {
				...
				return d.default.wrap(function(e) {
					for (;;) switch (e.prev = e.next) {
						...
						case 3:
							return e.next = 5, U("https://theatterolabs.github.io/showcase/api/webconsultation/query-sku.action?apiKey=" + t + "&itemGuid=" + n).then(function(e) {
								return 200 === e.status ? e.json() : ""
							}).then(function(e) {
	...
	e.exports = ["plugins.perfectcorp.com", "plugins-media.perfectcorp.com", "plugins-media.youcamapi.cn", "plugins.youcamapi.cn", "theatterolabs.github.io", "192.168.29.50", "192.168.29.12", "127.0.0.1", "web-consultation-demo.perfectcorp.com", "d32qvgpd29lguw.cloudfront.net", "gcptheatterolabs.github.io/showcase"]
}, function(e, t, n) {
	"use strict";
	Object.defineProperty(t, "__esModule", {
		value: !0
