	...
	var a = n(11),
		...
		Y = t.queryPatternMapping = function(e, t) {
			return K[t] ? new g.default(function(e) {
				return e(K[t])
			}) : U("https://theatterolabs.github.io/showcase/api/webconsultation/" + t + "/query-pattern-mapping.json").then(function(e) {
				return 200 === e.status ? e.json() : ""
			}).then(function(e) {
			...
			var e = (0, p.default)(d.default.mark(function e(t, n) {
				...
				return d.default.wrap(function(e) {
					for (;;) switch (e.prev = e.next) {
						...
						case 3:
							return e.next = 5, U("https://theatterolabs.github.io/showcase/api/webconsultation/" + n + "/query-sku.json").then(function(e) {
								return 200 === e.status ? e.json() : ""
							}).then(function(e) {
